    ...
    return (
        <div className={css.ingredient__container}>
            ...
            <Counter
                ...
                min={1}
                max={10}
                onChange={(count) => props.onChange({ ...props.item, count: count })}
            />
            <div className={css.price__delete}>
                <div className={css.add__container}></div>
                <div className={css.x}>
                    <p className={css.item__green}>{props.item.price * props.item.count} ₽</p>
